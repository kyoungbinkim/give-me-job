...
description: Write Korean job application cover letter drafts from a question, JD, resume.md, and optional company values input. Use when the user asks for 자기소개서, 자소서, 지원동기, 입사 후 포부, experience-based application answers, or tailored cover letter text grounded in resume.md evidence.
---
...
5. If evidence is missing, ask follow-up questions before drafting.
6. Draft in a structure suitable for the user's career type:
...
7. Produce an evidence map that links key sentences to `resume.md` evidence IDs.
8. Review for unsupported claims, company-name leftovers, vague enthusiasm, and length limit.
